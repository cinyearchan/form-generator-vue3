...
export function isObjectObject(t: object) {
  return toStr(t) === "[object Object]"
}
export function isObjectArray(t: object) {
  return toStr(t) === "[object Array]"
}
export function isObjectNull(t: object) {
  return toStr(t) === "[object Null]"
}
export function isObjectUnde(t: object) {
